...
export const getMenuItems = (user: User | null, _userLevel: number) => {
  ...
  const profileItems = [
    // Profile menu item removed - user profile section is now clickable in mobile menu
    ...
    // },
    // Contest Credits moved to Contests section
  ...
  const contestItems = [
    ...
    // Contest Credits moved from profile section
    {
      id: 'contest-credits',
