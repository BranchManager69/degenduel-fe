...
export const CelebrationOverlay: React.FC<CelebrationOverlayProps> = ({ finalValue, initialValue }) => {
    ...
    if (overlayRef.current && contentRef.current) {
      ...
      requestAnimationFrame(() => {
        if (overlayRef.current && contentRef.current) {
          ...
          contentRef.current.style.transition = 'transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)';
        }
      });
          ...
          {isWinner ? (
            <>
              ...
              <div className="text-2xl text-gray-100">
                You crushed it with a <span className="text-green-400">+{percentageChange.toFixed(1)}%</span> return!
              </div>
            ...
            <>
              ...
              <div className="text-2xl text-gray-100">
                Down bad with a <span className="text-red-400">{percentageChange.toFixed(1)}%</span> loss...
              </div>
              <div className="text-4xl animate-bounce">
                📉💸😭
              </div>
