          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <span className={`px-2 py-1 rounded text-sm ${
                contest.difficulty === 'whale' ? 'bg-purple-900 text-purple-100' :
                contest.difficulty === 'shark' ? 'bg-red-900 text-red-100' :
            ...
            <div className="space-y-2 text-sm text-gray-300">
              <div className="flex justify-between">
                <span>Entry Fee:</span>
                <span className="font-medium">{contest.entryFee} SOL</span>
              </div>
              <div className="flex justify-between">
                <span>Prize Pool:</span>
                <span className="font-medium text-brand-400">{contest.prizePool} SOL</span>
              </div>
              <div className="flex justify-between">
                <span>Players:</span>
              ...
              <div className="flex justify-between">
                ...
                <span>
                  {new Date(type === 'active' ? contest.endTime : contest.startTime).toLocaleString()}
                </span>
              </div>
            </div>
          </Link>
