    ...
    <section className="py-8 bg-gradient-to-b from-transparent via-dark-200/10 to-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                ...
                <div className="relative p-6 text-center">
                  ...
                  <p className="text-purple-300 font-bold text-base uppercase tracking-widest">Total Revenue</p>
                  <p className="text-xs text-purple-400/80 mt-1 font-medium">100% TO COMMUNITY</p>
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 max-w-6xl mx-auto">
          ...
          <StatItem
            label="Active Tokens"
            value={formatNumber(stats.active_tokens)}
            delay={0.4}
          />
          
          <StatItem
            label="Total Tokens"
            value={formatNumber(stats.token_discovery.by_source.dual_detection + stats.token_discovery.by_source.legacy)}
            delay={0.5}
          />
        </div>
