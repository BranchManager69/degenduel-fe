...
import { useJupiterWallet } from "../../social/useJupiterWallet";
...
export function useAuth() {
  ...
  useEffect(() => {
    console.warn(
      "⚠️ DEPRECATED: useAuth is deprecated and will be removed in a future version.\n" +
      "Please use the useMigratedAuth hook from src/hooks/auth/useMigratedAuth.ts instead.\n" +
