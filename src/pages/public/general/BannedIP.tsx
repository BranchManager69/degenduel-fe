...
export const BannedIP: React.FC = () => {
  ...
  const showToastExamples = () => {
    ...
    addToast(
      "success",
      "Successfully entered the trading competition!",
      "Competition Entry",
    );
    ...
    setTimeout(() => {
      addToast(
        "warning",
        "5 minutes remaining in current trading round",
        "Time Warning",
      );
    }, 2000);
    ...
    setTimeout(() => {
      addToast(
        "info",
        "New high-stakes competition starting in 10 minutes",
        "Upcoming Event",
      );
    }, 3000);
  };
    ...
    <div className="container mx-auto px-4 py-16 text-center">
      <div className="max-w-2xl mx-auto bg-dark-200/50 backdrop-blur-lg p-8 rounded-lg border border-red-500/50 shadow-lg">
        ...
        <div className="mt-8 pt-6 border-t border-red-500/20">
          ...
          <div className="mt-8 pt-6 border-t border-red-500/20">
            <h3 className="text-xl font-heading text-purple-400 mb-4">
              New Toast System Demo
            </h3>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              ...
              <button
                onClick={() =>
                  addToast("warning", "Proceed with caution", "Warning")
                }
              ...
              <button
                onClick={() =>
                  addToast("info", "Here's some information", "Info")
                }
