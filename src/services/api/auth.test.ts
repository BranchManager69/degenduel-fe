...
import { getSessionData, getWebSocketToken, verifyWalletSignature } from './auth';
...
describe('Authentication API Service', () => {
  ...
  describe('verifyWalletSignature', () => {
    ...
    it('should verify a wallet signature and return user data', async () => {
      ...
      const result = await verifyWalletSignature(mockWallet, mockSignature, mockMessage);
    ...
    it('should handle verification errors', async () => {
      ...
      await expect(verifyWalletSignature(mockWallet, mockSignature, mockMessage))
