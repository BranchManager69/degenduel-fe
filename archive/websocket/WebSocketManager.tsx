...
import { toast } from '../../src/components/toast/compat'; // Import the toast system directly
import { useAuth } from '../../src/hooks/useAuth';
import { ConnectionState, DDExtendedMessageType, SOCKET_TYPES, WEBSOCKET_ENDPOINT, WebSocketMessage } from '../../src/hooks/websocket/types';
import { setupWebSocketInstance } from '../../src/hooks/websocket/useUnifiedWebSocket';
import { useStore } from '../../src/store/useStore';
import { dispatchWebSocketEvent, initializeWebSocketTracking } from '../../src/utils/wsMonitor';
...
const WebSocketManagerComponent: React.FC = () => {
  ...
  const distributeMessage = (message: WebSocketMessage) => {
    ...
    const isSystemMessage = type === DDExtendedMessageType.SYSTEM;
