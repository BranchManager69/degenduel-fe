/**
 * ARCHIVED - DEPRECATED AI Service Implementation
 * 
 * This is an older version of the AI service that has been archived as of May 3, 2025.
 * The newer implementation in /src/services/ai.ts is what's actively being used.
 * 
 * Issues with this implementation:
 * - Created a circular dependency with the newer AI service by importing its types
 * - Was included in the API barrel file but not used directly in the application
 * - Contains significantly fewer features than the newer implementation (no WebSocket, streaming, etc.)
 * 
 * This file has been moved to the archive during a services code cleanup to reduce confusion
 * and remove unused code from the production bundle.
 * 
 * @archived 2025-05-03
 * @replaced-by /src/services/ai.ts
 */
  ...
  chat: async (
    ...
    try {
      ...
      return {
        ...
        // Remove usage property as it's not in the ChatResponse interface
