...
function showHelp() {
  console.log(`
Screenshot Tool - Flexible webpage screenshot utility

Usage: node screenshot-config.js [options] [routes...]
...
Examples:
  # Screenshot homepage only
  node screenshot-config.js
  
  # Screenshot specific routes
  node screenshot-config.js /contests /profile /dashboard
  node screenshot-config.js -r "/contests/123/results" -r "/leaderboard"
  
  # Use hash routing
  node screenshot-config.js "#/contests/demo/results" "#/profile"
  
  # Different server and output
  node screenshot-config.js -u "https://example.com" -o "./screenshots/"
  
  # Use config file
  node screenshot-config.js -c screenshot-routes.json
...
Config file format (JSON):
{
  ...
  "routes": [
    { "path": "/", "name": "homepage" },
    { "path": "/contests", "name": "contests-page" },
    { "path": "#/contests/demo/results", "name": "contest-results" }
  ]
}
`);
}
